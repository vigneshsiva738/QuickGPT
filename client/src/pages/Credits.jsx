...
function Credits() {
  ...
  return (<div className="max-w-7xl h-screen overflow-y-scroll mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div className="flex flex-wrap justify-center gap-8">
      {plans.map((plan)=>(
        ...
        <button className="mt-6 bg-purple-600 hover:bg-purple-700 active:bg-purple-800 text-white font-white py-2 rounded transition-colors cursor-pointer">Buy Now</button>
        </div>
        ))}
    </div>
  </div>)
